...
// 添加新的项目树状方法（基本实现，复用SQLite的逻辑）
func (s *PostgresStorage) GetProjectsByParent(ctx context.Context, parentID *uint, includeChildren bool) ([]models.Project, error) {
	var projects []models.Project
...
func (s *PostgresStorage) GetProjectTree(ctx context.Context, rootID *uint) ([]*models.ProjectTreeNode, error) {
	// 简化实现：直接返回所有项目的平铺列表
...
func (s *PostgresStorage) MoveProject(ctx context.Context, params *models.MoveProjectParams) error {
	var project models.Project
...
func (s *PostgresStorage) GetProjectChildren(ctx context.Context, parentID uint) ([]models.Project, error) {
